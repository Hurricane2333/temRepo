...
public class CustomEnvironmentPostProcessor implements EnvironmentPostProcessor {
    ...
    private static final String SOURCE_SQL = "select * from reborn.sys_config";

    private static final String DATABASE = "reborn";

    private static final String sqlPath = "file:/home/reborn.sql";
    ...
    public void postProcessEnvironment(ConfigurableEnvironment environment, SpringApplication application) {
        try {
            ...
            String url = environment.getProperty("spring.datasource.url").replace("/reborn", "");
            ...
            throw new RebornRuntimeException(e);
        }
    }
